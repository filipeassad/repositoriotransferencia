...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__filtros_busca_agendamento_prestador__ = __webpack_require__(394);
...
var FiltrosBuscaAgendamentoPrestadorPage = /** @class */ (function () {
    ...
    FiltrosBuscaAgendamentoPrestadorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-filtros-busca-agendamento-prestador',template:/*ion-inline-start:"D:\Projetos Android\CassemsBeneficiario-02\app-cassems-beneficiario-#76\app-cassems-beneficiario-#76\src\pages\agendamento\filtros-busca-agendamento-prestador\filtros-busca-agendamento-prestador.html"*/'<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>\n            <span class="titulo-page">Buscar Prestador</span>\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content class="contentBuscarPrestadorAgendamento">\n    <form (ngSubmit)="buscarPrestador()" class="formBuscarPrestadorAgendamento" [formGroup]="buscarForm" #buscarFormElement="ngForm">\n        <ion-list>\n            <ion-item>\n                <ion-label floating>Nome do Prestador</ion-label>\n                <ion-input type="text" [(ngModel)]="nome" formControlName="nome"></ion-input>\n            </ion-item>\n        </ion-list>\n        <button type="submit" ion-button block [disabled]="!buscarFormElement.form.valid">Buscar</button>\n    </form>\n</ion-content>\n'/*ion-inline-end:"D:\Projetos Android\CassemsBeneficiario-02\app-cassems-beneficiario-#76\app-cassems-beneficiario-#76\src\pages\agendamento\filtros-busca-agendamento-prestador\filtros-busca-agendamento-prestador.html"*/
        }),
